package com.century.chat.server;
...
public class Server implements Runnable {
			...
			while (running) {
				...
				if (text.equals("/raw")) {
					...
					for ( int i = 0; i < clients.size(); i++) {
						...
						System.out.println( "(" + c.getID()+""+ ")" + c.address.toString() + ":" + c.port+"" + "name: " + c.name );
					}
					System.out.println("===========================");
					...
					if (number) {
						...
						else System.out.println("Clients:" + id+"" + " doesn't exists! check ID number!");
					} else {
						for (int i =0 ;i < clients.size(); i++) {
							ServerClient c = clients.get(i);
					...
					System.out.println("Unknown commond.");
					printHelp();
				}
			}
			scanner.close();
	...
	private void disconnect( int id, boolean status ) {
		...
		String message = "";
		if (status) {
			message = "Disconnected£¡	" + " (" + c.getID()+"" + ")" + " @" + c.address.toString() +":" + c.port+"" + "	Client:" + c.name;
		} else {
			message = "Time out!	" + " (" + c.getID()+"" + " )" + "@ " + c.address.toString() +":" + c.port+"" + "	Client:" + c.name;
		}
		System.out.println(message);
	}
