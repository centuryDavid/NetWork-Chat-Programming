...
public class ClientWindow extends JFrame implements Runnable {
	...
	public ClientWindow(String name, String address, int port) {
		...
		createWindow();
		console("Attemping a  connection to " + address + ":" + port + ", user: " + name);
	...
	private void createWindow() {
		...
		gbl_contentPane.columnWidths = new int[]{40, 810, 30,10};
		gbl_contentPane.rowHeights = new int[]{70, 400, 80};
	...
	public void console(String messsage) {
		history.append(messsage + "\n\r");
	}
}
